...
//   if (weight <= 5 && age >= 1) return weight * 0.5
//   else if (weight >= 6 && weight <= 10 && age >= 1) return weight * 0.4
//   else if (weight >= 11 && weight <= 14 && age >= 1) return weight * 0.3
//   else if (weight >= 15 && age >= 1) return weight * 0.2
